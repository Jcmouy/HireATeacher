...
public class SpinnerAdapterNivel extends ArrayAdapter<Nivel> {

    private Context context;
    private List<Nivel> values;

    public SpinnerAdapterNivel(Context context,
                               List<Nivel> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        image.setImageResource(R.drawable.stairs);
